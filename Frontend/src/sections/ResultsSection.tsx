...
export default function ResultsSection() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      gsap.set(reportLines.children, { opacity: 0, y: 20 });
      ...
      ScrollTrigger.create({
        ...
        onEnter: () => {
          ...
          tl.to(leftCard, { x: 0, opacity: 1 }, 0)
            ...
            .to(reportLines.children, { y: 0, opacity: 1, stagger: 0.06 }, 0.15)
            .to(badge, { scale: 1, opacity: 1, ease: 'back.out(1.6)' }, 0.25);
        },
        once: true,
      });
    }, section);
  ...
  return (
    <section
      ...
      style={{ position: 'sticky', top: 0, zIndex: 5, backgroundColor: 'rgba(8,15,23,0.55)' }}
    >
      {/* Left Content Card */}
      <div
        ref={leftCardRef}
