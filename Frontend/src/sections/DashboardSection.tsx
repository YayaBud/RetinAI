...
export default function DashboardSection() {
      ...
      ScrollTrigger.create({
        ...
        onEnter: () => {
          ...
          tl.to(dashboard, { y: 0, scale: 1, opacity: 1 }, 0)
            ...
            .to(stats.children, { y: 0, opacity: 1, stagger: 0.05 }, 0.12)
            .to(chart, { x: 0, opacity: 1 }, 0.18)
            .to(list, { x: 0, opacity: 1 }, 0.18);
        },
        once: true,
      });
    }, section);
  ...
  return (
    ...
    >
      ...
      <div
        ref={dashboardRef}
        className="absolute bg-[#0d1a28] rounded-[28px] card-shadow border border-white/5 overflow-hidden"
        style={{
          left: '10vw',
          top: '14vh',
          width: '80vw',
