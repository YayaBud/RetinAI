...
class Trainer:
    ...
    def __init__(self, model, train_loader, val_loader, criterion, 
        ...
        # FIX: import from torch.amp (not torch.cuda.amp) and pass self.device
        self.scaler = GradScaler(self.device) if use_amp else None
    ...
    def train(self, save_checkpoint_fn=None, model_name='model', patience=100):
        """
        ...
        Args:
            ...
            patience: Early stopping patience — stops if val accuracy
